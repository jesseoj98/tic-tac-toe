...
public class TicTacToeValidator {
	...
	public boolean ticTacToe(char[][] gameBoard, char playingCharacter) {
		...
		final String topRow = String.valueOf(gameBoard[0][0]) + gameBoard[0][1] +
				gameBoard[0][2];
		final String middleRow = String.valueOf(gameBoard[1][0]) + gameBoard[1][1] +
				gameBoard[1][2];
		final String bottomRow = String.valueOf(gameBoard[2][0]) + gameBoard[2][1] +
				gameBoard[2][2];
		final String leftColumn = String.valueOf(gameBoard[0][0]) + gameBoard[1][0] +
				gameBoard[2][0];
		final String middleColumn = String.valueOf(gameBoard[0][1]) + gameBoard[1][1] +
				gameBoard[2][1];
		final String rightColumn = String.valueOf(gameBoard[0][2]) + gameBoard[1][2] +
				gameBoard[2][2];
